...
## Get to know MedRPG
Users can utilize MedRPG directly by accessing the web interface (by visiting ```3.0.76.41:7860```). The system supports image uploads by users, allowing them to obtain a corresponding grounded image based on the entered phrase. [xiaochen](http://3.0.76.41:7860)
